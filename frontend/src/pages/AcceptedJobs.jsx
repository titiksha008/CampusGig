...
//               <p>
//                 <strong>Category:</strong> {a.job?.category || "N/A"}
//               </p>
//               <p>
//                 <strong>Pay:</strong> ₹{a.job?.price || "N/A"}
//               </p>
//               <p>
//                 <strong>Deadline:</strong>{" "}
//                 {a.job?.deadline
//                   ? new Date(a.job.deadline).toLocaleDateString()
//                   : "No deadline"}
//               </p>
//               <p>
//                 <strong>Posted by:</strong> {a.job?.postedBy?.name || "Unknown"}
//               </p>
//               <p>
